  ...
  return (
    <div className='projectcontainer'>
      ...
      <div className='firstprj'>
        ...
        <a href='https://frontend-5e9v.onrender.com' target='_blank'><button>Check It Out</button></a>
        </div>
       <img src={firstprj}></img>
      </div>
      


      <div className='secondprj'>
      <img src={secondprj}></img>
        <div className='prjinfo'>
        ...
        <a href='https://github.com/kausik11/needs-grocery-app.git' target='_blank'><button>Check It Out</button></a>
        </div>
